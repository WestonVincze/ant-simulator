...
import { AnimationAction, AnimationMixer, Mesh, Points } from "three";
...
export const FoodPheromoneMeshRef = trait<{ ref: Points | null }>({ ref: null });
export const HomePheromoneMeshRef = trait<{ ref: Points | null }>({ ref: null });
